...
use \App\Pay\Alipay\V2\Aop\EncryptParseItem;

//require_once 'EncryptParseItem.php';

use \App\Pay\Alipay\V2\Aop\SignData;
...
class AopCertClient
{
    use \App\Pay\Alipay\V2\Aop\AopEncrypt;
    use \App\Pay\Alipay\V2\Aop\AopCertification;
